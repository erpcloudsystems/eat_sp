...
class EmployeeAdvanceFilter extends StatefulWidget {
  const EmployeeAdvanceFilter({Key? key}) : super(key: key);
  ...
  @override
  State<EmployeeAdvanceFilter> createState() => _EmployeeAdvanceFilterState();
}

class _EmployeeAdvanceFilterState extends State<EmployeeAdvanceFilter> {
    ...
    return Column(
      children: [
        CustomDropDown(
          ...
          'Status'.tr(),
          fontSize: 14,
          items: EmployeeAdvanceFilter._statusList,
