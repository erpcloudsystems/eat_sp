...
class ExpenseClaimFilter extends StatefulWidget {
  const ExpenseClaimFilter({Key? key}) : super(key: key);
  ...
  @override
  State<ExpenseClaimFilter> createState() => _ExpenseClaimFilterState();
}

class _ExpenseClaimFilterState extends State<ExpenseClaimFilter> {
    ...
    return Column(
      children: [
        CustomDropDown(
          'filter1',
          'Status'.tr(),
          items: ExpenseClaimFilter._statusList,
