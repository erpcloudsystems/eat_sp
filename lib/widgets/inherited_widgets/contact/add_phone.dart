...
import 'package:next_app/widgets/inherited_widgets/contact/email_table_model.dart';
import 'package:next_app/widgets/inherited_widgets/contact/phone_table_model.dart';
...
class InheritedContactForm extends InheritedWidget {
  InheritedContactForm(
      {Key? key, required Widget child, List<PhoneModel>? phones,List<EmailModel>? emails,})
      : this.phones = phones ?? [],this.emails = emails ?? [],
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              ...
                              Timer(Duration(milliseconds: 50), () => _EmailScrollController.animateTo(_EmailScrollController.position.maxScrollExtent, duration: Duration(milliseconds: 200), curve: Curves.easeInOut));
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Flexible(
                                          flex:3,
                                          child:
                                          CustomTextField('email_id', tr('Email'),
                                            initialValue: InheritedContactForm.of(
                                                context)
                                                .emails[index]
                                                .emailId,
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Flexible(
                                          child: CheckBoxWidget('is_primary_phone', 'Is Primary Email'.tr(),
                                            fontSize: 11,
                                            initialValue:
                                            InheritedContactForm.of(
                                                context)
                                            ...
                                            onChanged: (id, value) =>
                                                setState(() => InheritedContactForm.of(
                                                    context)
                                                    .emails[index]
                                                    .isPrimary = value ? 1 : 0),
                                          ),
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              ...
                              Timer(Duration(milliseconds: 50), () => _phoneScrollController.animateTo(_phoneScrollController.position.maxScrollExtent, duration: Duration(milliseconds: 200), curve: Curves.easeInOut));
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Flexible(
                                          flex:3,
                                          child:
                                          CustomTextField('phone', tr('Phone'),
                                            initialValue: InheritedContactForm.of(
                                                context)
                                                .phones[index]
                                                .phone,
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Flexible(
                                          child: CheckBoxWidget('is_primary_phone', 'Is Primary Phone'.tr(),
                                            fontSize: 11,
                                            initialValue:
                                            InheritedContactForm.of(
                                                context)
                                                .phones[index]
                                                .isPrimaryPhone == 1 ? true : false,
                                            onChanged: (id, value) =>
                                                setState(() => InheritedContactForm.of(
                                                    context)
                                                    .phones[index]
                                                    .isPrimaryPhone = value ? 1 : 0),
                                          ),
                                        ),
                                        SizedBox(width: 10,),

                                        Flexible(
                                          child: CheckBoxWidget('is_primary_mobile_no', 'Is Primary Mobile'.tr(),
                                            fontSize: 11,
                                            initialValue:
                                            InheritedContactForm.of(
                                                context)
                                                .phones[index]
                                                .isPrimaryMobile == 1 ? true : false,
                                            onChanged: (id, value) =>
                                                setState(() => InheritedContactForm.of(
                                                    context)
                                                    .phones[index]
                                                    .isPrimaryMobile = value ? 1 : 0),
                                          ),
                                        ),
