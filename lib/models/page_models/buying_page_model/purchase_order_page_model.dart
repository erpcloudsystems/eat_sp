...
class PurchaseOrderPageModel {
    ...
    return [
      {
        ...
        tr("Required By Date"): reverse(data['schedule_date'])
      },
      {
  ...
  List<Map<String, String>> get card2Items {
    return [
      ...
      },
      {
        ...
        tr("Pricing List Currency"): data['price_list_currency'].toString(),
      },
      {
  ...
  List<String> itemListValues(int index) {
    return [
      data['purchase_order_items'][index]['delivery_date'] == null
          ? tr('none')
          : reverse(data['items'][index]['delivery_date']),
      data['purchase_order_items'][index]['item_code'] ?? tr('none'),
      data['purchase_order_items'][index]['item_name'] ?? tr('none'),
      data['purchase_order_items'][index]['description'] ?? tr('none'),
      data['purchase_order_items'][index]['item_group'] ?? tr('none'),
      data['purchase_order_items'][index]['brand'] ?? tr('none'),
      //  data['items'][index]['image'] ,
      data['purchase_order_items'][index]['qty'].toString(),
      data['purchase_order_items'][index]['uom'] ?? tr('none'),
      data['purchase_order_items'][index]['uom'] ?? tr('none'),
      data['purchase_order_items'][index]['conversion_factor'].toString(),
      data['purchase_order_items'][index]['stock_qty'].toString(),
      currency(data['purchase_order_items'][index]['price_list_rate']),
      currency(data['purchase_order_items'][index]['base_price_list_rate']),
      data['purchase_order_items'][index]['margin_type'] ?? tr('none'),
      data['purchase_order_items'][index]['margin_rate_or_amount'].toString(),
      currency(data['purchase_order_items'][index]['rate_with_margin']),
      percent(data['purchase_order_items'][index]['discount_percentage']),
      currency(data['purchase_order_items'][index]['discount_amount']),
      currency(data['purchase_order_items'][index]['base_rate_with_margin']),
      currency(data['purchase_order_items'][index]['rate']),
      currency(data['purchase_order_items'][index]['net_rate']),
      currency(data['purchase_order_items'][index]['amount']),
      data['purchase_order_items'][index]['item_tax_template'] ?? tr('none'),
      currency(data['purchase_order_items'][index]['net_amount']),
      currency(data['purchase_order_items'][index]['base_rate']),
      currency(data['purchase_order_items'][index]['base_net_rate']),
      currency(data['purchase_order_items'][index]['base_amount']),
      currency(data['purchase_order_items'][index]['base_net_amount']),
      currency(data['purchase_order_items'][index]['billed_amt']),
      currency(data['purchase_order_items'][index]['valuation_rate']),
      currency(data['purchase_order_items'][index]['gross_profit']),
      data['purchase_order_items'][index]['warehouse'] ?? tr('none'),
      data['purchase_order_items'][index]['prevdoc_docname'] ?? tr('none'),
      data['purchase_order_items'][index]['projected_qty'].toString(),
      data['purchase_order_items'][index]['actual_qty'].toString(),
      data['purchase_order_items'][index]['ordered_qty'].toString(),
      data['purchase_order_items'][index]['planned_qty'].toString(),
      data['purchase_order_items'][index]['work_order_qty'].toString(),
      data['purchase_order_items'][index]['delivered_qty'].toString(),
      data['purchase_order_items'][index]['produced_qty'].toString(),
      data['purchase_order_items'][index]['returned_qty'].toString(),
      data['purchase_order_items'][index]['additional_notes'] ?? tr('none'),
    ];
  }
