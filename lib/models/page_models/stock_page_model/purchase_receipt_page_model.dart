...
class PurchaseReceiptPageModel {
  final Map<String, dynamic> data;
  final BuildContext context;

  PurchaseReceiptPageModel(this.context, this.data)
  ...
  List<Map<String, String>> get card1Items {
    return [
      ...
      {
        tr("Address"): formatDescription(data['address_line1'] ?? tr('none')),
      },
      {
      ...
      },
      {
        ...
        tr("Contact Email"): data['email_id'] ?? tr('none'),
      }
    ];
  }
