            ...
            child: Column(
              children: [
                ...
                CustomTextField(
                  ...
                  clearButton: true,
                  onSave: (key, value) => operations['workstation'] = value,
                  onPressed: () async {
                    final res = await Navigator.of(context).push(
                        MaterialPageRoute(
                ...
                CustomTextField(
                  ...
                  initialValue: operations['hour_rate'] != null &&
                      ...
                      ? (operations['hour_rate'] * operations['time_in_mins'])
                          .toString()
                      : '0.0',
                  onSave: (key, value) =>
                      operations['operating_cost'] = double.tryParse(value),
                ),
                ...
                CheckBoxWidget(
                  ...
                  fontSize: 16,
                  initialValue: operations['fixed_time'] == 1 ? true : false,
                  onChanged: (id, value) =>
