        ...
        PageCard(
          ...
          header: [
            Stack(
              ...
              children: [
                Text('Stock Entry', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
          ...
          child: Column(
            children: [
              Container(
                ...
                child: Center(child: Text('Items', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold))),
              ),
              Expanded(
